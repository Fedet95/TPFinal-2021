                            ...
                            foreach ($allCareers as $car) {
                                ...
                                if ($car->getActive() == 'true' && $car->getDescription() == "University technician in textile production") {
                                    ...
                                    <input type="hidden" name="valueToSearch"
                                           value="<?php echo $car->getDescription() ?>">
                                    <input type="submit" class=" btn btn-light-1 c-filter  ml-auto" name="button"
                    ...
                    <div class="col-md-9 post-list">
                        <ul class="cat-list">
                            ...
                            <?php if (isset($searchedValue)) {
                                ...
                                } else if(empty($searchedValue) && isset($validateMessage) && $validateMessage==1){
                                    ?>
                            ...
                            <div class="form-group offset-7">  <!--JOB POSITION FILTER-->
                                <table>
                                    ...
                                    <tr>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="valueToSearch" class="form-control"
                                                        ...
                                                        foreach ($allOffers as $value) {
                                                            $flag = 0;
                                                            if ($loggedUser->getRol()->getUserRolId() == 1 || $loggedUser->getRol()->getUserRolId() == 3) {
                                        ...
                                        <th>
                                            <input type="submit" class="btn btn-light ml-auto filtre-button"
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <form action="<?php echo FRONT_ROOT . "Job/showJobOfferManagementView" ?>"
                                                  method="post"
                                            ">
                                            <input type="submit" name="all" class="btn btn-close-white ml-auto"
                                                   value="Show all Offers">
                                            </form>
                                        </th>
                                        </th>
                                    </tr>
                        ...
                        foreach ($allOffers as $value) {
                            ...
                            foreach ($allCompanies as $company) {
                                if ($value->getCompany()->getCompanyId() == $company->getCompanyId()) {
                                    ...
                                    if ($value->getActive() == "true" && $company->getActive() == 'true' && strtotime($value->getEndDate()) >= strtotime(date("Y-m-d")) && ($loggedUser->getRol()->getUserRolId() == 2 || $loggedUser->getRol()->getUserRolId() == 1)){
                                        ?>
                                                ...
                                                <ul class="btns">
                                                    <td>
                                                        <form action="<?php echo FRONT_ROOT . "Job/showJobOfferViewMore" ?>"
                                                            ...
                                                            <button type="submit" name="id"
                                                                    ...
                                                                    value="<?php echo $value->getJobOfferId() ?>"> View
                                                                More
                                                            </button>
                                                        </form>
                                                        <br>
                                                    ...
                                                    <?php if ($loggedUser->getRol()->getUserRolId() == 2) { ?>
                                                        ...
                                                        <?php } else { ?>
                                                            <td>
                                                                <input type="button" id="show-option" value="Apply"
                                                                       title="This offer does not correspond to your career"
                                                                       class="btn buttonPer disabled ml-auto d-block">
                                                                <br>
                                                            </td>
                                        ...
                                        if ($loggedUser->getRol()->getUserRolId() == 1) {
                                                ...
                                                <div class="single-post d-flex flex-row">
                                                    ...
                                                    <div class="details">
                                                        <div class="offset-3 title d-flex flex justify-content-between">
                                                            <div class="titles">
                                                                <a href="single.html">
                                                                    <h4><?php echo $value->getTitle() ?></h4></a>
                                                                <!--TITLE-->
                                                                <h5><?php echo $company->getName() ?></h5>
                                                                <!--COMPANY NAME-->
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <div class="row offset-3">
                                                            ...
                                                            <!--DEDICATION-->
                                                            <p class="address"><span class="lnr lnr-map"></span>
                                                                Country: <?php echo $company->getCountry()->getName() ?>
                                                            </p>
                                                            <!--COUNTRY-->
                                                            <p class="address"><span class="lnr lnr-map"></span>
                                                                City: <?php echo $company->getCity()->getName() ?> </p>
                                            ...
                                            if($loggedUser->getEmail()==$company->getEmail()) { ?>
                                                ...
                                                <div class="single-post d-flex flex-row">
                                                    ...
                                                    <div class="details">
                                                        ...
                                                        <br>
                                                        <div class="row offset-3">
                                                            <?php if(strtotime($value->getEndDate()) < strtotime(date("Y-m-d")) || $value->getActive() == "false"){?>
                                                            <p class="text-strong text-muted ">Inactive</p>
                                                    <?php }?>
                                                            <h5 class=""> <!--CAREER-->
                                                                <I> <?php echo $value->getCareer()->getDescription() ?></I>
                                ...
                                <div class="row  col-sm-10 offset-sm-1 text-center bg-light-alpha p-5 border">
                                    ...
                                    <div class="form-group offset-3 col-7">
                                        ...
                                        <select name="career" class="form-control" required>
                                            <option value="" disabled selected class="text-center">Select referring
                                                career
                                            </option>
                                    ...
                                    <button type="submit" name="button"
                                            class="btn btn-dark offset-5 d-block my-3 col-3 justify-content-center">
                                        Continue
                                    </button>
                                </div>
                            </form>
    ...
    <?php } else {
        if (($careerId != null)) {
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $jobOfferEdit->getTitle() ?>" name="title" class="form-control"
                       required
                    ...
                    <select name="position[]" multiple class="form-control" required="required">
                        ...
                        foreach ($jobOfferEdit->getJobPosition() as $valueJ) {
                            if ($valueJ->getCareer()->getCareerId() == $careerId) {
                                ?>
                                <option selected
                                        value="<?php echo $valueJ->getJobPositionId() ?>"><?php echo $valueJ->getDescription() ?></option>
                                <?php
            ...
            <option selected value="<?php echo $jobOfferEdit->getRemote() ?>"
                    class="text-center"><?php echo $jobOfferEdit->getRemote() ?></option>
        ...
        <div class="form-group col-lg-15">
            ...
            <select name="dedication" class="form-control" required>
                <option selected value="<?php echo $jobOfferEdit->getDedication() ?>"
                        class="text-center"><?php echo $jobOfferEdit->getDedication() ?></option>
        ...
        <div class="col-lg-15">
            <div class="form-group">
                ...
                <p><textarea name="description" placeholder="" class=" wide form-control"
                             required> <?php echo htmlspecialchars($jobOfferEdit->getDescription()); ?></textarea></p>
            </div>
        </div>

        <div class="col-lg-15">
            <div class="form-group">
                <label class="text-muted text-strong" for="">Salary</label><br>
                <input required type="number" name="salary" value="<?php echo $jobOfferEdit->getSalary() ?>" min="0.00"
                       step="0.01"
            </div>
        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-center offset-sm-1 text-center bg-light-alpha p-5 border">
                            ...
                            <div class="form-group col-3">
                                ...
                                <input type="text" name="company" id="contactNo" readonly
                                       class="form-control text-center" value="<?php echo $company->getName() ?>">
                            </div>


                            <div class="form-group col-3">
                                <label class="text-muted text-strong text" for="">Publish Date</label>
                                <input type="text" name="publishdate" class="form-control text-center"
                                       value="<?php echo $jobOffer->getPublishDate() ?>"
                                       readonly>
                            </div>
                            ...
                            <div class="form-group col-3">
                                ...
                                <input type="text" name="active" class="form-control text-center"
                                       value="<?php if ($jobOffer->getActive() == 'true') {
                                           echo "Active";
                                       } else {
                                           echo "Inactive";
                                       } ?>" readonly>
                    ...
                    <div class="container">
                        <form action="<?php echo FRONT_ROOT . "Job/removeJobOffer" ?>" method="POST">
                            ...
                            <div class="justify-content-center align-items-center offset-sm-1 text-center bg-light-alpha border py-3">
                                <p class="text-strong h6">The job offer you want to delete currently has applications,
                                    please confirm if you want to continue.</p>
                                <br>
                                <div class="form-group">
                                    <p class="text-muted text-strong text">Confirmation</p>
                                    <label for="active" class="h5">Accept</label>
                                    <input type="radio" name="accept" value="true" class="radioSize" required
                                           id="active">
                                    <br>
                                ...
                                <div class="form-group">
                                    <br>
                                    <button type="submit" name="button" class="offset-3 btn btn-dark ml-auto">CONFIRM
                                    </button>
                                </div>
                            </div>
                        </form>
                                ...
                                <div class="container">
                                    <form action="<?php echo FRONT_ROOT . "Job/removeJobOffer" ?>" method="POST">
                                        ...
                                        <div class="justify-content-center align-items-center offset-sm-1 text-center bg-light-alpha border py-5">
                                            <p class="text-strong">Send a message to the applicants notifying them of
                                                the withdrawal.</p>
                                            <br>

                                            <div class="form-group">
                                                <label class="text-muted text-strong text" for="">Subject</label>
                                                <input type="text" name="sub" class="form-control text-center offset-2"
                                                       style="width: 675px; height: 30px"
                                                       placeholder="Enter email subject here..." required>
                                            </div>

                                            <div class="form-group">
                                                <textarea name="text" class="form-control offset-2"
                                                          placeholder="Message..." style="width: 675px; height: 30px"
                                                          required></textarea>
                                            </div>
                                            <div class="form-group">
                                                <br>
                                                <button type="submit" name="button"
                                                        class="offset-2 btn btn-dark ml-auto">SEND
                                                </button>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <section id="">
                                ...
                                <div class="container">
                                    <form action="<?php echo FRONT_ROOT . "Job/showJobOfferManagementView" ?>"
                                          method="POST">
                                        <div class="justify-content-center align-items-center offset-sm-1 text-center bg-light-alpha border py-5">
                                            <p class="offset-2 text-muted form-control "
                                               style="width: 675px; height: 30px"><?php echo $finalMessage ?></p>
                                            <div class="form-group">
                                                <br>
                                                <button type="submit" name="button"
                                                        class="offset-2 btn btn-dark ml-auto">BACK
                                                </button>
                                            </div>
                                        </div>
                                    </form>
